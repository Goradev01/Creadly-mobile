    ...
    return design.layout(SafeArea(
      child: SingleChildScrollView(
        child: Padding(
          ...
          child:
              Consumer<ProductProvider>(builder: (context, productData, child) {
            List<ProductData> data = productData.productQueryData;
            return Column(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              design.amount(design.ash, 20.0,
                                  data[0].price.toString(), FontWeight.w500),
                              const Spacer(),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(width: 1, color: design.shadeP)),
                          child: Text('+',
                              style:
                                  TextStyle(fontSize: 14, color: design.blue)),
                        ),
                      ),
                      Container(
                        height: 39,
