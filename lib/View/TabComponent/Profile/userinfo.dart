  ...
  Widget build(BuildContext context) {
    ...
    return design.layout(SingleChildScrollView(
      child: Padding(
        ...
        child: Consumer<UserDataProvider>(builder: (context, data, child) {
                ...
                if (snapshot.connectionState.name == 'done') {
                  return Column(
                    ...
                    children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: design.input(design.numb, 8,
                                      'Email Address', FontWeight.w500),
                                ),
                                design.input(design.ash, 10,
                                    snapshot.data?[0].email, FontWeight.w500),
                                Padding(
                                  padding:
                                      const EdgeInsets.only(top: 20, bottom: 5),
                                  child: design.input(design.numb, 10,
                                      'Phone Number', FontWeight.w500),
                                ),
                                design.input(
                                    design.ash,
                                    10,
                              ...
                              children: [
                                ...
                                Padding(
                                  padding:
                                      const EdgeInsets.only(top: 20, bottom: 5),
                                  child: design.input(design.numb, 10,
                                      'Company Code', FontWeight.w500),
                                ),
                                design.input(
                                    design.ash,
                                    10,
                                    snapshot.data?[0].companyCode != null
                                        ? '${snapshot.data?[0].companyCode}'
                                        : '',
                                    FontWeight.w500),
                                Padding(
                                  padding:
                                      const EdgeInsets.only(top: 20, bottom: 5),
                                  child: design.input(design.numb, 10,
                                      'Date Of Birth', FontWeight.w500),
                                ),
                                design.input(
                                    design.ash,
                                    10,
                                    snapshot.data?[0].dateOfBirth != null
                                        ? '${snapshot.data?[0].dateOfBirth} '
                                        : '',
                                    FontWeight.w500),
                              ],
                            ),
                      ...
                      design.input(design.ash, 10, snapshot.data?[0].email,
                          FontWeight.w500),
                      Padding(
                        padding: const EdgeInsets.only(top: 20, bottom: 5),
                        child: design.input(
                            design.numb, 10, 'Gender', FontWeight.w500),
                      ),
                      ...
                      Padding(
                        ...
                        child: design.input(
                            design.ash, 10, 'Password', FontWeight.w500),
                      ),
                      Container(
                        width: width,
                        alignment: Alignment.center,
